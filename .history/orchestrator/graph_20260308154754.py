...
def route_after_execution(state: BuildState):
    ...
    if status == "EXECUTED" and (    if  descriptor.get("application_type") == "batch-job" or descriptor.get("application_type") == "cli" or descriptor.get("application_type") == "frontend":
):
        return END
    ...
    if descriptor.get("long_running") == "RUNNING"  :
        return "healthcheck"
